...
from hdnet.sampling import sample_from_bernoulli, sample_from_ising_gibbs, sample_from_ising_metropolis, sample_from_dichotomized_gaussian, \
...
class Ising(SpikeModel):
    ...
    def sample_from_model(self, J=None, theta=None, trials=None, reshape=False, sampler='metropolis'):
        """
        ...
        for c, t in enumerate(trials):
            ...
            if sampler is 'gibbs':
                ...
                X[c, :, :] = sample_from_ising_metropolis(J, theta, self._original_spikes.M)
